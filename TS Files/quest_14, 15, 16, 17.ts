...
let guestList: string[] = ["Maaz", "Mahad", "Ali", "Saad"];
let dinnerInvite: string =
...
let informingGuests: string =
  " \t \t Great news, everyone! I've managed to find a bigger table for our dinner party! \n";
...
while (guestList.length > 2) {
  ...
  console.log(
    " Sorry " + removedGuests + " We can't invite you to dinner party \n"
  );
}
console.log("\n\tRemaining Guests\n");
