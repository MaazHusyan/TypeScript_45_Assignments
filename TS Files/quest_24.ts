...
let cartoon: string = "jerry";
let cartoon2: string = "JERRY";
// Example 1: Equality (==)
...
console.log(
  "Is cartoon2 is equal to 'jerry'? Using lowerCase I predict False."
);
...
let buffet: string[] = ["biryani", "palao", "tikka", "malai boti", "chapati"];
